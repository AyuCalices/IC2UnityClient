...
namespace Plugins.EventNetworking.Identification
{
    ...
    public class ObjectChangeEventListener
    {
            ...
            for (int i = 0; i < stream.length; ++i)
            {
                ...
                switch (type)
                {
                    case ObjectChangeKind.CreateGameObjectHierarchy:
                        CreateGameObjectHierarchy(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.ChangeGameObjectStructureHierarchy:
                        ChangeGameObjectStructureHierarchy(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.ChangeGameObjectStructure:
                        ChangeGameObjectStructure(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.ChangeGameObjectParent:
                        ChangeGameObjectParent(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.ChangeGameObjectOrComponentProperties:
                        ChangeGameObjectOrComponentProperties(i, type, ref stream, DEBUG);
                        break;
        
                    /*
                    case ObjectChangeKind.ChangeScene:
                        ChangeScene(i, type, ref stream, DEBUG);
                        break;
                    
                    case ObjectChangeKind.DestroyGameObjectHierarchy:
                        DestroyGameObjectHierarchy(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.CreateAssetObject:
                        CreateAssetObject(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.DestroyAssetObject:
                        DestroyAssetObject(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.ChangeAssetObjectProperties:
                        ChangeAssetObjectProperties(i, type, ref stream, DEBUG);
                        break;

                    case ObjectChangeKind.UpdatePrefabInstances:
                        UpdatePrefabInstances(i, type, ref stream, DEBUG);
                        break;*/
        ...
        private static void ChangeGameObjectOrComponentProperties(int i, ObjectChangeKind type, ref ObjectChangeEventStream stream, bool debug)
        {
            ...
            else if (goOrComponent is UnityEngine.Component component && component.gameObject != null)
            {
                if (debug)
                {
